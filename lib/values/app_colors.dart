...
abstract class AppColors {
  static const Color colorPrimaryApp = Colors.blue;
  static const Color colorPrimaryApp2 = Colors.blue;

  static const Color colorActive = Colors.blue;
  static const Color colorInActive = Color(0xffB3B3B4);
  static const Color colorCardPrimary = Color(0xffD3E7FF);
  static const Color colorBoldCardPrimary = Colors.blue;
  static const Color colorTextPrimay = Colors.blue;
  static const Color pageBackground = Color(0xFFFAFBFD);
  static const Color colorSuccess = Color.fromARGB(255, 86, 255, 156);

  static const Color colorIconPrimary = Colors.blue;
  static const Color colorProgress = Colors.blue;
